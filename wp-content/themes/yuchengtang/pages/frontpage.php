...
<div class="bg">
	<div class="content wrapper">
		<div class="tickets">
			...
			<p style="color:#A57239;margin-top:25px;margin-bottom:5px;font-size:18px;font-weight:bold"><span class="text-cn">周二 ~ 周六</span><span class="text-en">OPEN Tuesday - Saturday</span><p>
			...
			<p style="color:#3d5079;font-size:18px;margin-top:20px;border-top:1px dotted #999;padding-top:10px">
				...
				<span class="text-en" style="font-size:16px">17 Floor, Yinyi Bingjiang Center, No. 55-56, Lane 21, Pu San Road, Pudong New District, Shanghai, P. R. China. (Turn Right at He Yi Hotel)</span>
			</p>
			<div class="more">
